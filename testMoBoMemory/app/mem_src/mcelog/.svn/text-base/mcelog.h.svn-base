...
struct mce_bank_msrs {
    int bank;
    __u64   IA32_MCi_CTL;
    __u64   IA32_MCi_STATUS;
    __u64   IA32_MCi_ADDR;
    __u64   IA32_MCi_MISC;
    __u64   IA32_MCi_CTL2;
};

struct mce_global_ctrl_msrs {
    __u64   IA32_MCG_CAP;
    __u64   IA32_MCG_STATUS;
    __u64   IA32_MCG_CTL;
};
...
#define MCE_GET_BANK_MSRs    _IOWR('M', 4, struct mce_bank_msrs)

#define MCE_GET_GLOBAL_CTRL_MSRs    _IOR('M', 5, struct mce_global_ctrl_msrs)
